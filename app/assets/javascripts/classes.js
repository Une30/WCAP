...
function ColorInfo() { //Edit this
    ...
    this.red    = new ColorInfo_Key('red',   'قرمز',   '#F00');
    this.yellow = new ColorInfo_Key('yellow','زرد','#FF0');
    this.green  = new ColorInfo_Key('green', 'سبز', '#0F0');
    this.blue   = new ColorInfo_Key('blue',  'آبی',  '#55F');
}
...
ColorSilo.prototype.toString = function() {
    var output = '';
    output += '-قرمز: '    + this.red.value    + "\n";
    output += '-زرد: ' + this.yellow.value + "\n";
    output += '-سبز: '  + this.green.value  + "\n";
    output += '-آبی: '   + this.blue.value   + "\n";
