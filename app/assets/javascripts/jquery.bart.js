...
(function($) {
    ...
    $.fn.bart = function( method ) {
        ...
        var opts = {
            ...
            sndpath: '/assets/',              // path to sound files
            randomize:       true,           // randomize order of balloons
            frmid:           'bartdat',      // hidden form element to save all data to
            separator:       [':', '\n'],     // value separators in hidden form field (0: within in balloon, 1: between ballons)
         ...
         * Save results
         */
        balloon.prototype.save = function(last) {
            ...
            if (last == 1) {
                console.log("Result Array is ready");
                console.log(r);
            } else {
                console.log("R is : " + r);
                var rows = r.split(":");
                ...
                var pumps = rows[1];
                var explosion = rows[2];
		console.log("ex == " + explosion );
                var response_time = rows[3];
		document.getElementById('balloon_pumps').value = pumps;
		document.getElementById('balloon_explosion').value = explosion;  		
		document.getElementById('balloon_response_time').value = response_time;
                /*rows.forEach(function (row) {
                    console.log("each Element is "+ row);
                });*/
                //console.log(rows);
            }
