	...
	var maxTiral = 120 ; // number of trials
...
var listener =  function (event , CharCode) {
    ...
    if (window.charCode == constant_clicked) {
        ...
        document.getElementById('rectangle_response_time').value = getTimeMSec();
    ...
    setTimeout(function () {
        ...
        setTimeout(function () {
            ...
            setTimeout(function () {
                ...
                document.getElementById('rectangle_display_time').value = getTimeMSec();
                document.addEventListener("keypress", listener);
                console.log("Counter == " + counter);

                setTimeout(function () {
                    console.log(" charcode in loop == " + window.charCode);
		    document.getElementById('rectangle_state').value = state ;
		    document.getElementById('rectangle_is_clicked').value = 0;
                    if (window.charCode == constant_clicked) {
                        console.log("fahmidaaaaaaam : " + window.charCode);
			document.getElementById('rectangle_is_clicked').value = 1;
                    }
                if (window.is_clicked == 0) {
                    //save "Click Time" in MSec
                    document.getElementById('rectangle_response_time').value = getTimeMSec();
                }
		    $("#submit_rectangle").click();
                if (counter >= maxTiral) {
                    clearTimeout(play);
