...
class StroopsControllerTest < ActionController::TestCase
  ...
  test "should create stroop" do
    assert_difference('Stroop.count') do
      post :create, stroop: { before_stimulation: @stroop.before_stimulation, correct_items: @stroop.correct_items, duration: @stroop.duration, task_id: @stroop.task_id, total_items: @stroop.total_items }
    end
  ...
  test "should update stroop" do
    patch :update, id: @stroop, stroop: { before_stimulation: @stroop.before_stimulation, correct_items: @stroop.correct_items, duration: @stroop.duration, task_id: @stroop.task_id, total_items: @stroop.total_items }
    assert_redirected_to stroop_path(assigns(:stroop))
  end
