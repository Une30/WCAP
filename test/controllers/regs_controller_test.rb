...
class RegsControllerTest < ActionController::TestCase
  ...
  test "should create reg" do
    assert_difference('Reg.count') do
      post :create, reg: { clinic_id: @reg.clinic_id, patient_id: @reg.patient_id, user_id: @reg.user_id }
    end
  ...
  test "should update reg" do
    patch :update, id: @reg, reg: { clinic_id: @reg.clinic_id, patient_id: @reg.patient_id, user_id: @reg.user_id }
    assert_redirected_to reg_path(assigns(:reg))
  end
