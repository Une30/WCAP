class SupervisorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @supervisor.save
        format.html { redirect_to @supervisor.clinic, notice: 'Supervisor was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @supervisor.update(supervisor_params)
        format.html { redirect_to @supervisor.clinic, notice: 'Supervisor was successfully updated.' }
  ...
  private
    ...
    def supervisor_params
      params.require(:supervisor).permit(:user_id, :clinic_id)
    end
end
